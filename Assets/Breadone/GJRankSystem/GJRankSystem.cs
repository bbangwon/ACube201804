...
public class GJRankSystem : MonoBehaviour {
    ...
    protected string phpFile = "GameJamRank/GJRank.php";
    public string url = "http://127.0.0.1/";

    protected int myGameID = -1;
    ...
    protected JObject GetRequestJson(string command, JObject content)
    {
    ...
    protected resultMessage MakeResult(JObject res)
    {
    ...
    protected IEnumerator PostData(JObject postData, System.Action<JObject> onComplete)
    {
